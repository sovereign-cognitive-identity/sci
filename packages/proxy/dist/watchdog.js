...
function revertSystemProxy(reason) {
    try {
...
export function saveProxyState(port) {
    try {
        const sciDir = join(homedir(), '.sci');
        if (!existsSync(sciDir))
            mkdirSync(sciDir, { recursive: true });
...
export function startWatchdog(port) {
