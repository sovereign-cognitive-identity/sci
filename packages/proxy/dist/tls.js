...
export function getCACertPath() { return join(CERT_DIR, 'ca.crt'); }
export function getCAKeyPath() { return join(CERT_DIR, 'ca.key'); }
// ── CA cert ───────────────────────────────────────────────────────────────────
export function ensureCACert() {
...
export function getCertForHost(hostname, ca) {
