 ...
 */
export function installCleanupHelper(fakeCIDR, resolverDomains) {
 ...
 */
export function writeRecoveryScript() {
    mkdirSync(SCI_DIR, { recursive: true });
...
export function deleteRecoveryScript() {
    try {
 ...
 */
export function runRecoveryIfStale() {
    if (!existsSync(RECOVER_SCRIPT))
        return;
...
export function registerTUNCleanup(fn) {
    _cleanupFn = fn;
...
//# sourceMappingURL=tun-guard.js.map